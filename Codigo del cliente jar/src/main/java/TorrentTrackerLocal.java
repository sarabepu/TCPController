...
public class TorrentTrackerLocal {
...
//		saveTorrent(t,torrentFile);
	    ...
	    TorrentMetadata metadata = new MetadataBuilder()
	            .addFile(new File("C:/Users/Profesor/Documents/monitoria/nueva/destino/ubuntu.exe"))
	            .setTracker("http://0.0.0.0:6969/announce")
	            .build();
	    saveTorrent(metadata,new File("./archivos/torrents/nuevo.torrent"));
